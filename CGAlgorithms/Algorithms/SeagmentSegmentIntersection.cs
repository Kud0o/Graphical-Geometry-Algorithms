...
{
    class SeagmentSegmentIntersection : Algorithm
    {
        public override void Run(List<Point> points, List<Line> lines, List<Polygon> polygons, ref List<Point> outPoints, ref List<Line> outLines, ref List<Polygon> outPolygons)
        {
            ...
            Point s2 = lines[1].Start;// first point - second line
            Point e2 = lines[1].End; // second point - second line
           ...
           //  Line L = new Line(O, intersect);
            if (CGUtilities.HelperMethods.PointOnSegment(intersect, lines[0].Start, lines[0].End) && CGUtilities.HelperMethods.PointOnSegment(intersect, lines[1].Start, lines[1].End))
            outPoints.Add(intersect);

        }
        public override string ToString()
        {
            return "SegmentSegmentIntersect";
        }
