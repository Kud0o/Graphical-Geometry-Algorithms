...
{
    class PolygonPolygonIntersect: Algorithm
    {
        ...
        public override void Run(List<Point> points, List<Line> lines, List<Polygon> polygons, ref List<Point> outPoints, ref List<Line> outLines, ref List<Polygon> outPolygons)
        {
            ...
            {
                Point s = polygons[1].lines[j].Start; // first point - first line
                Point e = polygons[1].lines[j].End; // second point - first line
                ...
                if (CGUtilities.HelperMethods.PointOnSegment(intersect, polygons[1].lines[j].Start, polygons[1].lines[j].End) && CGUtilities.HelperMethods.PointOnSegment(intersect, polygons[0].lines[i].Start, polygons[0].lines[i].End))
